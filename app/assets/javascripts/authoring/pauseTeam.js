...
$("#requestEditSubmitBtn").click(function(){
    ...
    currentTeam.logActivity("$('#requestEditSubmitBtn').click(function()",'Clicked Submit Button to Submit Request to Change Team - Type of Change: ' + selected, form_content);
